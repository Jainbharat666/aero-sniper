...
color 0A
echo ===================================================================
echo      🚀 PUSHING AERO-SNIPER V2 SCRIPT CODE TO GITHUB... 🚀
echo ===================================================================
echo.
cd /d "%~dp0"
...
:: Step 3: Configure remote origin safely using .git_token if needed
echo [3/5] Verifying remote origin...
set GHTOKEN=
...
echo [4/5] Staging script code files...
git add .

:: Step 5: Commit with timestamp
echo [5/5] Committing with timestamp...
...
echo.
echo ===================================================================
echo   🎉 DONE! Aero-Sniper V2 script pushed successfully!
